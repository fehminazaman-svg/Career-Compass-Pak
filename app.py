...
page = st.sidebar.radio("Go to:", ["🏠 Home", "👤 Student Assessment", "🎯 Recommendations", "🎓 Education Explorer", "💰 Scholarships & Expenses", "💼 Career Opportunities", "🗺 My Roadmap"])
...
if page == "🏠 Home":
    ...
    if api_key and "profile" in st.session_state:
        ...
        response = client.chat.completions.create(
            ...
            messages=[{"role": "system", "content": "You are Career Compass Pakistan, an educational guidance assistant."},
